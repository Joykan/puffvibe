      ...
      <section className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div key={index} className={`bg-white p-6 rounded-lg shadow-md text-center border-2 ${tier.popular ? 'border-purple-500 border-2' : 'border-gray-200'}`}>
              {tier.popular && (
                <span className="bg-purple-500 text-white px-3 py-1 rounded-full text-sm font-medium mb-2 inline-block">
                  Most Popular
                </span>
              )}
              <h3 className="text-xl font-semibold text-gray-800">{tier.name}</h3>
              <p className="text-2xl font-bold text-purple-600 my-2">KSh {tier.price}</p>
